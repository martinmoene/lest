...
#if 0
// VC:
cl -EHsc -Dlest_FEATURE_AUTO_REGISTER=1 -I.. -I../../../include lest_expect_assert.t.cpp && lest_expect_assert.t.exe --pass
// suppress portability/security warnings
cl -W3 -EHsc -Dlest_FEATURE_AUTO_REGISTER=1 -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -I.. -I../../../include lest_expect_assert.t.cpp && lest_expect_assert.t.exe --pass
// Note: omit 'c' (extern "C" defaults to nothrow) in -EHsc when you throw through C functions
cl -O2 -W3 -EHs -Dlest_FEATURE_AUTO_REGISTER=1 -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -I.. -I../../../include lest_expect_assert.t.cpp && lest_expect_assert.t.exe --pass

// GNUC:
g++ -Wall -std=c++03 -Dlest_FEATURE_AUTO_REGISTER=1 -I.. -I../../../include -o lest_expect_assert_cpp03.t.exe lest_expect_assert.t.cpp && lest_expect_assert_cpp03.t.exe --pass
g++ -Wall -std=c++11 -Dlest_FEATURE_AUTO_REGISTER=1 -I.. -I../../../include -o lest_expect_assert.t.exe       lest_expect_assert.t.cpp && lest_expect_assert.t.exe       --pass
#endif
