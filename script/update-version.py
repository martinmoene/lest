...
#        , r'set\W+lest_version\W+"([0-9]+\.[0-9]+(\.[0-9]+)?)"\W+$'
#        , 'set( lest_version "{major}.{minor}" )\n' )
#
#    , ( 'script/install-xxx-pkg.py'
#        , r'\lest_version\s+=\s+"([0-9]+\.[0-9]+\.[0-9]+)"\s*$'
#        , 'lest_version = "{major}.{minor}.{patch}"\n' )
    ...
    , ( 'include/lest/lest.hpp'
        , r'\#define\s+lest_MAJOR\s+[0-9]+\s*$'
        , '#define lest_MAJOR  {major}' )

    , ( 'include/lest/lest.hpp'
        , r'\#define\s+lest_MINOR\s+[0-9]+\s*$'
        , '#define lest_MINOR  {minor}' )

    , ( 'include/lest/lest.hpp'
        , r'\#define\s+lest_PATCH\s+[0-9]+\s*$'
        , '#define lest_PATCH  {patch}\n' )
